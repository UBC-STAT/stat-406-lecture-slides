...
.pull-right[
__All subsets__: estimate model based on every possible subset of size $\min\{n, p\}$, use one with 
...
`r con` takes $2^p$ model fits ($p<n$). If $p=50$, this is about $10^{15}$ models. 
