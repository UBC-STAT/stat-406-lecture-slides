...
If $L(y,\ f(x))= \exp(-y f(x))$, $G$ is a classifier, and $y \in \{-1, 1\}$ then this is equivalent to AdaBoost. Proven 5 years later (Friedman, Hastie, and Tibshirani 2000). Called 
