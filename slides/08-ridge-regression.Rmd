...
$$\brl = \arg \min_{ \beta} \sum_i (y_i-x^\top_i \beta)^2 + \lambda || \beta ||_2^2.$$
...
Note also: I'm going to stop multiplying by $1/n$. The effect is to scale $\lambda$.
...
Best linear regression model of size $t$: $\min \frac{1}{n}||\y-\X\beta||_2^2 \textrm{ subject to } ||\beta||_0 \leq t$
