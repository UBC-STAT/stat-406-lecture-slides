...
* This is hosted by UBC <https://learning.github.ubc.ca/STAT-406-101-2021W/>
...
* Note that MDS uses both of these, the department uses both, Google / Amazon / Facebook use things like these, etc.
...
```
git clone https://learning.github.ubc.ca/STAT-406-101-2021W/wkshts-labs-dajmcdon.git
```
2. Create a **branch**
```
...
* You make a branch
* *DO NOT* rename files
* Make enough commits (2 for labs, 5 for HW).
...
* In RStudio, select the file and click `r fa("cog", fill="blue")` `r fa("caret-down")` then select `r fa("undo", fill="red")` Revert...
```
